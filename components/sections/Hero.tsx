          ...
          <div className="lg:col-span-7 flex flex-col space-y-md">
            ...
            <div>
              ...
              <h2 className="font-heading text-xl md:text-3xl text-muted-foreground font-semibold leading-snug">
                Full Stack Developer building AI-powered applications, intelligent software systems, and modern web experiences.
              </h2>
            </div>
            
            {/* Intro */}
            <p className="font-sans text-lg text-muted-foreground/80 max-w-2xl leading-relaxed">
              I enjoy solving real-world engineering problems through Full Stack Development, Artificial Intelligence, and Embedded Systems. I focus on building practical, scalable, and user-friendly software solutions while continuously learning modern technologies.
            </p>
            
            {/* Actions */}
            <div className="flex flex-wrap gap-4 pt-4">
              <Button variant="default" className="font-heading text-sm px-6 py-5 rounded-lg flex items-center gap-2 group">
                View Projects
              ...
              <Button variant="secondary" className="font-heading text-sm px-6 py-5 rounded-lg flex items-center gap-2">
                Download Resume
              ...
              <Button variant="ghost" className="font-heading text-sm px-6 py-5 rounded-lg flex items-center gap-2">
                Contact Me
              </Button>
            </div>
            ...
            <div className="mt-8 flex flex-col gap-2">
              ...
              <div className="flex flex-wrap gap-2">
                <Badge variant="outline" className="px-3 py-1 bg-white/5 border-white/10 hover:border-secondary/50 hover:-translate-y-0.5 transition-all cursor-default">Python</Badge>
                <Badge variant="outline" className="px-3 py-1 bg-white/5 border-white/10 hover:border-secondary/50 hover:-translate-y-0.5 transition-all cursor-default">JavaScript</Badge>
                <Badge variant="outline" className="px-3 py-1 bg-white/5 border-white/10 hover:border-secondary/50 hover:-translate-y-0.5 transition-all cursor-default">React</Badge>
                <Badge variant="outline" className="px-3 py-1 bg-white/5 border-white/10 hover:border-secondary/50 hover:-translate-y-0.5 transition-all cursor-default">PyTorch</Badge>
                <Badge variant="outline" className="px-3 py-1 bg-white/5 border-white/10 hover:border-secondary/50 hover:-translate-y-0.5 transition-all cursor-default">MySQL</Badge>
                <Badge variant="outline" className="px-3 py-1 bg-white/5 border-white/10 hover:border-secondary/50 hover:-translate-y-0.5 transition-all cursor-default">Git</Badge>
                <Badge variant="outline" className="px-3 py-1 bg-white/5 border-white/10 hover:border-secondary/50 hover:-translate-y-0.5 transition-all cursor-default">Arduino</Badge>
              </div>
            </div>
          </div>
          
          {/* Right: Abstract Engineering Visual */}
