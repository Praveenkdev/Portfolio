...
export function HeroContent() {
  return (
    <div className="lg:col-span-7 flex flex-col space-y-md">
      <StaggerContainer waitForBoot staggerDelay={0.2} className="flex flex-col space-y-md">
        {/* Heading */}
        <StaggerItem>
          ...
          {/* Removed fixed height to allow typewriter to natively push content down if it wraps */}
      ...
      <StaggerContainer waitForBoot staggerDelay={0.2} initialDelay={2.6} className="flex flex-col space-y-md">
        {/* Intro */}
        <StaggerItem>
          <p className="font-sans text-lg text-muted-foreground/80 max-w-2xl leading-relaxed mt-2">
